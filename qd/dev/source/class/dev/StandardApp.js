	...
	members: {
		...
		*/
		setupStandardApp: function (skipSystem, customSplitPane) {
			...
			dev.Api.UserProperties({}, {}, this, function () {
				...
				if (dev.PageVisibility.getInstance().isHidden()) {
					...
					function () {
						...
						if (label != props["CurrentConnection"] ) {
							...
							dev.Api.SwitchServerConnection(obj,
							function (response) {
		...
		*/
		getAppsMenu: function () {
			...
			var welcome = new qx.ui.menu.Button("Welcome To Helix Development",
					"dev/icon/16x16/plain/home.png");
			dev.Statics.setHtmlID( welcome, "Welcome");
			var adminBtn = new qx.ui.menu.Button("Helix Administration",
					"dev/icon/16x16/plain/control_panel.png");
			dev.Statics.setHtmlID( adminBtn, "Admin");
			var devBtn = new qx.ui.menu.Button("Helix Development",
					"dev/icon/16x16/plain/compass.png");
			dev.Statics.setHtmlID( devBtn, "Dev");
		...
		*/
		getServerMenu: function () {
			...
			var btnNew = new qx.ui.menu.Button("New Connection...",
					"dev/icon/16x16/plain/server_connection.png");
			dev.Statics.setHtmlID( btnNew, "NewConnection");
			...
			var btnMng = new qx.ui.menu.Button("Manage Connections",
					"dev/icon/16x16/plain/server_edit.png");
			dev.Statics.setHtmlID( btnMng, "ManageConnections");
		...
		*/
		addToServerMenu: function (newLabel) {
			...
			dev.Statics.setHtmlID( btn, newLabel);
		...
		addCloseConnection: function () {
			...
			var closeBtn = new qx.ui.menu.Button("Close Current Connection",
				"dev/icon/16x16/plain/server_delete.png");
			dev.Statics.setHtmlID( closeBtn, "CloseCurrentConnection");
		...
		*/
		...
		showWelcome: function () {
			...
			if (tab_page != null) { // brand new
				...
				tab_page.add(new dev.HomePage(0), { flex: 10 });
			}
		},
		...
		showUpdates : function () {
			...
			if (tab_page != null) { // brand new
				...
				tab_page.add(new dev.help.CheckForUpdates(0), { flex: 10 });
			}
		},
		...
		*/
		...
		getSplitPane: function () {
			...
			dev.Statics.setHtmlID( this.tree, "ExplorerTree" );
		...
		createTreeRMC: function () {
			...
			dev.Statics.addToRMCMenu(this.treeRMC, "Refresh Tree",
				"dev/icon/16x16/plain/refresh.png", this.fillTree, this);
			dev.Statics.addToRMCMenu(this.treeRMC, "View Selected Item",
				"dev/icon/16x16/plain/eye_blue.png", this.viewTreeSelection, this);
			dev.Statics.addToRMCMenu(this.treeRMC, "Delete Selected Item",
		...
		viewTreeSelection: function () {
			if (this.tree.getSelection().length === 0) {
				dev.Statics.doAlert("There is nothing selected in the tree.",
			...
			if (treeNode.editObject){
				...
				dev.Statics.doAlert("There is nothing to view for the current selection.",
					"Alert", this.setTreeFocus, this);
			}
		...
		getTreeToolBar: function () {
			...
			dev.Statics.addToToolbar(part0, "dev/icon/16x16/plain/refresh.png",
				"Refresh Tree", function(e) {this.doTada(); this.fillTree();}, this, this, "Refresh");

			dev.Statics.addToToolbar(part0, "dev/icon/16x16/plain/eye_blue.png",
				"View/Modify Tree Selection", this.viewTreeSelection, this, this, "View");

			dev.Statics.addToToolbar(part0, "dev/icon/16x16/plain/delete2.png",
		...
		getMainToolBar: function () {
			...
			dev.Statics.setHtmlID( appsMenu, "Applications" );
			...
			dev.Statics.setHtmlID( toolsMenu, "Tools" );
			...
			dev.Statics.setHtmlID( this.serverMenu, "ServerMenu" );
		...
		getFileMenu: function () {
			...
			this.addMenuButton(menu, "Control+Alt+R", "Refresh List",
				"dev/icon/16x16/plain/refresh.png", null, this.fillTree);
