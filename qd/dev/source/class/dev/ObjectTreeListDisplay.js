...
qx.Class.define("dev.ObjectTreeListDisplay", {
	...
	members : {
		...
		createRMCMenu : function(ev) {
			...
			// refresh
			dev.Statics.addToRMCMenu( this.rmc, "Refresh",
				'dev/icon/basic_foundation/16x16/plain/refresh.png', this.rmcFullRefresh, this);

			// edit
			dev.Statics.addToRMCMenu( this.rmc, "Edit...",
				'dev/icon/basic_foundation/16x16/plain/edit.png', this.rmcEdit, this);

			// Add New...
			if(this.doAddNew){
				dev.Statics.addToRMCMenu( this.rmc, "Add New...",
					'dev/icon/basic_foundation/16x16/plain/document_new.png', this.addNew, this);
			}

			// Delete...
			if(this.deleteApi !== null){
				dev.Statics.addToRMCMenu( this.rmc, "Delete...",
					'dev/icon/basic_foundation/16x16/plain/delete2.png', this.doDelete, this);
			}
