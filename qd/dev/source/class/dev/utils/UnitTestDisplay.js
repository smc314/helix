...
************************************************************************ */
/* ************************************************************************
#asset(dev/icon/16x16/plain/bullet_triangle_glass_blue.png)
#asset(dev/icon/64x64/shadow/stethoscope.png)
#asset(dev/icon/16x16/plain/barcode.png)
************************************************************************ */
qx.Class.define("dev.utils.UnitTestDisplay", {
	...
	members : {
		...
		initializeToolbar : function( tb ) {
			...
			dev.Statics.addToToolbar( part, "dev/icon/16x16/plain/bullet_triangle_glass_blue.png",
		...
		createMainTab: function(tab_page)
		{
			var live = this.createOverviewLayout( tab_page, "Unit Test",
				"dev/icon/64x64/shadow/stethoscope.png",
			...
			this.testsTable.getTableColumnModel().setDataCellRenderer(
				2, new dev.utils.StatusCellRenderer() );
		...
		{
			var objectList = dev.sqldo.UnitTestSummary.readElementChildren(response);
		...
		executeUnitTest : function() {
			...
			dev.Api.SendRequest(requestDoc, this.dataObject.getTestUrl(),
