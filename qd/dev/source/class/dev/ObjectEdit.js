	...
	members :
	{
		...
		*/
		initializeToolbar : function(tb)
		{
			...
			// Save button
			dev.Statics.addToToolbarWithShortcut(sc_part, "dev/icon/16x16/plain/floppy_disk_ok.png", this.tr("Save To Server"), this.doSaveToServer, this, this, null, "Save");

			// Revert button
			dev.Statics.addToToolbarWithShortcut(sc_part, "dev/icon/16x16/plain/refresh.png", this.tr("Reload From Server"), this.doRevert, this, this, null, "Revert");
			tb.add(sc_part);
			return tb;
		},
		addHelpMenu : function(tb)
		{
			...
			// Help button
			dev.Statics.addToToolbar(help_part, "dev/icon/16x16/plain/help2.png", this.tr("View Help"), this.doShowHelp, this, this, "Help");
			tb.add(help_part);
			return tb;
		},
		createRMCMenu : function(ev)
		{
			...
			// refresh
			dev.Statics.addToRMCMenu(this.rmc, "Refresh", 'dev/icon/16x16/plain/refresh.png', this.doRevert, this);
			return this.rmc;
		},
		hideRMC : function()
		{
		...
		*/
		...
		createOverviewLayout : function(layoutParent, editorName, editorIcon, objName)
		{
			...
			root.add(this.initGeneralStatus(editorName, editorIcon, objName), {
				flex : 1
			});
			root.add(live, {
				flex : 10
		...
		initGeneralStatus : function(type, icon, name)
		{
			...
			var l1 = new qx.ui.basic.Label(type).set( {
				allowGrowX : true
			});
