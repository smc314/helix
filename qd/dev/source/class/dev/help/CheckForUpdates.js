...
qx.Class.define("dev.help.CheckForUpdates", {
	...
	members : {
		...
		initializeToolbar : function( tb ) {
			...
			// Download button
			dev.Statics.addToToolbarWithShortcut(sc_part, "dev/icon/16x16/plain/download.png",
				this.tr("Download Selected Release"), this.doDownload, this, this, "Control-D");

			// Install button
			dev.Statics.addToToolbarWithShortcut(sc_part, "dev/icon/16x16/plain/server_into.png",
		...
		createMainTab: function(tab_page)
		{
			var live = this.createOverviewLayout( tab_page, "Ivory Hub Releases",
				"dev/icon/64x64/shadow/download.png",
				"Download Releases" );
