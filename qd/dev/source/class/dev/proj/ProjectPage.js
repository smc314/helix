	...
	members :
	{
		...
		*/
		doFormLayout : function()
		{
			...
			this.projectContainer.add(this.projectList, {
				flex : 10
			});
			this.editorTabs = new qx.ui.tabview.TabView;
			this.editorContainer.add(this.editorTabs, {
				flex : 10
			});
		...
		createListToolbar : function()
		{
			...
			toolbar.add(part0);
			dev.Statics.addToToolbar(part0, "dev/icon/16x16/plain/refresh.png", "Refresh Project List", this.getProjectData, this, this, "Refresh");
			dev.Statics.addToToolbar(part0, "dev/icon/16x16/plain/components.png", "Add New Project", this.doNewProject, this, this, "New");
			dev.Statics.addToToolbar(part0, "dev/icon/16x16/plain/delete2.png", "Delete Selected Projects", this.doDeleteProjects, this, this, "Delete");
			return toolbar;
		},
		...
		doNewProject : function()
		{
			...
			if (tab_page !== null)
			{
				...
				tab_page.add(new dev.proj.ProjectEditor(0), {
					flex : 10
				});
			}
		},
		...
		editProject : function(proj)
		{
			...
			{
				tab_page.setIcon("dev/icon/16x16/plain/components.png");
				tab_page.add(new dev.proj.ProjectEditor(proj), {
					flex : 10
				});
			}
		}
