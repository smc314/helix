...
/* ************************************************************************
#asset(dev/icon/64x64/shadow/server_connection.png)
************************************************************************ */
...
/** This class defines a dialog that presents a list box
  ...
  */
qx.Class.define("dev.dialog.ServerConnectDialog",
{
	...
	{
		this.icon = "dev/icon/64x64/shadow/server_connection.png";
	...
	members :
	{
		...
		doFormLayout : function(layout)
		{
			...
			layout.add(a1);
			dev.Statics.addFieldsToForm(this, layout, "Name:", 70, "aliasField", "TextField");
			dev.Statics.addFieldsToForm(this, layout, "Host Name:", 70, "hostField", "TextField");
			dev.Statics.addFieldsToForm(this, layout, "Port#:", 70, "portField", "TextField");
			dev.Statics.addFieldsToForm(this, layout, "User Name:", 70, "userField", "TextField");
			dev.Statics.addFieldsToForm(this, layout, "Password:", 70, "passField", "PasswordField");
