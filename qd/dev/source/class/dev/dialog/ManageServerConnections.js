...
qx.Class.define("dev.dialog.ManageServerConnections", {
	...
	members : {
		...
		doFormLayout : function ( layout ) {
			...
			dev.Statics.addBoxWithButtons( this, layout, "listBox", 1, 1,
				"deleteBtn", "Delete", "dev/icon/16x16/plain/delete2.png"
			);

			this.listBox.setSelectionMode( "multi" );
			this.deleteBtn.addListener("execute", this.deleteSelection, this );
			dev.Api.UserProperties( {}, {}, this, this.loadList );
		...
		deleteSelection: function() {
			...
			dev.Api.UserProperties( {}, delList, this, this.loadList );
		}
