...
/** This class defines a simple dialog base class that defines a dialog window
  ...
  */
qx.Class.define("dev.dialog.CancelDialog", {
	...
	construct : function ( title, addToolbar ) {
		...
		this.cancel_btn = new qx.ui.form.Button("OK", "dev/icon/16x16/plain/error.png");
		dev.Statics.setHtmlID( this.cancel_btn, "OK" );
	...
	members : {
		...
		addButton : function (buttonLabel, buttonIcon) {
			...
			dev.Statics.setHtmlID( btn, buttonLabel );
