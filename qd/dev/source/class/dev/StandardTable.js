...
qx.Class.define("dev.StandardTable",
{
	...
	members :
	{
		...
		setEditableAsDropDown : function(colNum, ddValues)
		{
			...
			var propCellRendererFactory = new qx.ui.table.cellrenderer.Dynamic(function(cellInfo)
			{
			...
			var propCellEditorFactory = new qx.ui.table.celleditor.Dynamic(function(cellInfo)
			{
