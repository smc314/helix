...
************************************************************************ */
qx.Class.define("admin.ObjectListDisplay", {
	...
	members : {
		...
		createRMCMenu : function(ev) {
			...
			// refresh
			admin.Statics.addToRMCMenu( this.rmc, "Refresh", 'admin/icon/basic_foundation/16x16/plain/refresh.png',
				this.rmcFullRefresh, this);

			// edit
			admin.Statics.addToRMCMenu( this.rmc, "Edit...", 'admin/icon/basic_foundation/16x16/plain/edit.png',
				this.rmcEdit, this);

			// Add New...
			if(this.doAddNew){
				admin.Statics.addToRMCMenu( this.rmc, "Add New...", 'admin/icon/basic_foundation/16x16/plain/document_new.png',
					this.addNew, this);
			}

			// Delete...
			if(this.deleteApi !== null){
				admin.Statics.addToRMCMenu( this.rmc, "Delete...", 'admin/icon/basic_foundation/16x16/plain/delete2.png',
					this.doDelete, this);
			}
		...
		rmcEdit : function(ev) {
			...
			if( this.table.getSelectionModel().isSelectionEmpty() ){
				admin.Statics.doAlert("Nothing selected to edit!");
				return;
			}
	...
	destruct : function () {
		...
		admin.Statics.cleanupStandardTable( this.table );
