...
************************************************************************ */
/* ************************************************************************
#asset(admin/icon/64x64/shadow/server_to_client.png)
************************************************************************ */
...
/** This class defines a dialog that presents a list box
  ...
  */
qx.Class.define("admin.dialog.LRTaskDialog", {
	...
	construct : function ( lrTask, callback, errorCallback, callbackThis ) {
		this.lrTask = lrTask;
		this.icon = "admin/icon/64x64/shadow/server_to_client.png";
	...
	members : {
		...
		runLongPoll : function(userData, timerId) {
			...
			req.onreadystatechange = qx.lang.Function.bind( function() {
				...
				if(admin.Api.returnHasErrors( response, true, this.errorCallback, this.callbackThis ) ){
