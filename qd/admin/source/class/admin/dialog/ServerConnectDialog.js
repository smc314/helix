...
************************************************************************ */
/* ************************************************************************
#asset(admin/icon/64x64/shadow/server_connection.png)
************************************************************************ */
...
/** This class defines a dialog that presents a list box
  ...
  */
qx.Class.define("admin.dialog.ServerConnectDialog", {
	extend : admin.dialog.OKCancelDialog,

	/** You may pass in window title, icon, and label values.
	  */
	construct : function ( title) {
		this.icon = "admin/icon/64x64/shadow/server_connection.png";
