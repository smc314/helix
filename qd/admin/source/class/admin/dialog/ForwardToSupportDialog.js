...
************************************************************************ */
/* ************************************************************************
#asset(admin/icon/64x64/shadow/user_headset.png)
#asset(admin/icon/16x16/plain/download.png)
#asset(admin/icon/16x16/plain/server_from_client.png)
************************************************************************ */
...
/** This class defines a dialog that presents choice for the user in how they want to forward
  ...
  */
qx.Class.define("admin.dialog.ForwardToSupportDialog", {
	extend : admin.dialog.CancelDialog,
	...
	construct : function ( forwardToSupportFileName ) {
		...
		this.icon = "admin/icon/64x64/shadow/user_headset.png";
		...
		this.downloadBtn = this.addButton( "Download Zip", "admin/icon/16x16/plain/download.png" );
		this.forwardBtn = this.addButton( "Use Direct Send", "admin/icon/16x16/plain/server_from_client.png" );
	...
	members : {
		...
		handleForward: function() {
			var fileObj = new admin.sqldo.SupportBundle;
			fileObj.setFileName( this.forwardFile );
			admin.Api.ForwardFileToSupport( fileObj, function(response) {
				admin.Statics.doAlertGreen(
