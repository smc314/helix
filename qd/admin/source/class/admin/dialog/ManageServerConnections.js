...
/** This class defines a dialog that presents a list box
  ...
  */
qx.Class.define("admin.dialog.ManageServerConnections", {
	...
	members : {
		...
		doFormLayout : function ( layout ) {
			var a1 = new qx.ui.basic.Atom("Use the delete button to remove any server connections that are no longer required.", "admin/icon/64x64/shadow/server_edit.png" );
			a1.setRich( true );
			layout.add(a1);

			admin.Statics.addBoxWithButtons( this, layout, "listBox", 1, 1,
				"deleteBtn", "Delete", "admin/icon/16x16/plain/delete2.png"
			);

			this.listBox.setSelectionMode( "multi" );
			this.deleteBtn.addListener("execute", this.deleteSelection, this );
			admin.Api.UserProperties( {}, {}, this, this.loadList );
		...
		deleteSelection: function() {
			...
			admin.Api.UserProperties( {}, delList, this, this.loadList );
		}
