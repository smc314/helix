...
************************************************************************ */
/* ************************************************************************
#asset(admin/icon/16x16/plain/arrow2_left_blue.png)
#asset(admin/icon/16x16/plain/arrow2_right_blue.png)
#asset(admin/icon/16x16/plain/ok.png)
...
/** This class defines a simple dialog base class that defines a dialog window
  ...
  */
qx.Class.define("admin.dialog.WizardDialog", {
	...
	construct : function ( title, icon ) {
		...
		this.prev_btn = new qx.ui.form.Button(this.tr("Back"), "admin/icon/16x16/plain/arrow2_left_blue.png");
		this.prev_btn.setIconPosition("left");
		hbl.add(this.prev_btn);
		admin.Statics.setHtmlID( this.prev_btn, "Back" );
		this.next_btn = new qx.ui.form.Button(this.tr("Next"), "admin/icon/16x16/plain/arrow2_right_blue.png");
		this.next_btn.setIconPosition("right");
		hbl.add(this.next_btn);
		admin.Statics.setHtmlID( this.next_btn, "Next" );
		var sp1 = new qx.ui.core.Spacer();
		sp1.setWidth(10);
		hbl.add(sp1);
		this.ok_btn = new qx.ui.form.Button(this.tr("Finish"), "admin/icon/16x16/plain/ok.png");
		hbl.add(this.ok_btn);
		admin.Statics.setHtmlID( this.ok_btn, "Finish" );
		var sp2 = new qx.ui.core.Spacer();
		sp2.setWidth(10);
		hbl.add(sp2);
		this.close_btn = new qx.ui.form.Button(this.tr("Cancel"), "admin/icon/16x16/plain/error.png");
		hbl.add(this.close_btn);
		admin.Statics.setHtmlID( this.close_btn, "Cancel" );
