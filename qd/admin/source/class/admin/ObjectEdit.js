...
#asset(admin/icon/16x16/plain/floppy_disk_ok.png)
#asset(admin/icon/16x16/plain/refresh.png)
#asset(admin/icon/16x16/plain/help2.png)
************************************************************************ */
qx.Class.define("admin.ObjectEdit", {
	...
	members: {
		...
		*/
		setupNamesAndFunctions: function () {
			this.selectApiCall = admin.Api.selectOneProductInfo;
		...
		*/
		initializeToolbar: function (tb) {
			...
			// Save button
			admin.Statics.addToToolbarWithShortcut(sc_part, "admin/icon/16x16/plain/floppy_disk_ok.png",
		...
		addHelpMenu: function (tb) {
			...
			// Help button
			admin.Statics.addToToolbar(help_part, "admin/icon/16x16/plain/help2.png",
		...
		createRMCMenu: function (ev) {
			...
			// refresh
			admin.Statics.addToRMCMenu(this.rmc, "Refresh", 'admin/icon/16x16/plain/refresh.png',
				this.doRevert, this);
		...
		getHelpUrl: function () {
			return "/admin/NetHelp/admin.htm";
		},
