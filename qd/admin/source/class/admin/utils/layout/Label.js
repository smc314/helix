 ...
 * required to be known for manipulating Label layout entities.
 */
qx.Mixin.define("admin.utils.layout.Label", {

	members: {

		/** This will create an xml node with our default values.
		 */
		createXmlNodeForLabel: function(xmlNodeParent)
		{
			var xmlNode = xmlNodeParent.ownerDocument.createElement( "Label" );
			xmlNode.setAttribute( "varName", "" );
			xmlNode.setAttribute( "text", "Text to display" );
			xmlNode.setAttribute( "paddingTop", "3" );
			return xmlNode;
		},
		...
		/** This will return a list of node names that can be children of our
		  ...
		  */
		validChildrenForLabel: function()
		{
			return [ ];
		},
		 ...
		 */
		editDetailsForLabel: function(treeNode, xmlNode)
		{
			this.reRenderSettingsPane( "LayoutDesigner.Label.xml" );
			this.pushXmlToFields( xmlNode, [
				"varName", "text", "paddingTop"
			] );
		},
		...
		/** This will read the data out of the given XML node and convert it into a
		  ...
		  */
		testSettingsForLabel: function(xmlNode, testSettingsArray)
		{
