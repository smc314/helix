...
************************************************************************ */
/* ************************************************************************
#asset(admin/icon/16x16/plain/edit.png)
#asset(admin/icon/16x16/plain/document_new.png)
#asset(admin/icon/16x16/plain/delete2.png)
************************************************************************ */
qx.Class.define("admin.StandardTable", {
		...
		createRMCMenu : function() {
			...
			if(this.getEditRowFunction() !== null){
				admin.Statics.addToRMCMenu( this.rmc, "Edit...",
					"admin/icon/16x16/plain/edit.png",
					this.rmcEdit, this );
			}
			...
			if(this.getAddRowButton() !== null){
				admin.Statics.addToRMCMenu( this.rmc, "Add New...",
					"admin/icon/16x16/plain/document_new.png",
