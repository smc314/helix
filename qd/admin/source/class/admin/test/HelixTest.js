 ...
 *
 */
qx.Class.define("admin.test.HelixTest",
{
	...
	members :
	{
		...
		/**
		  ...
		  */
		setUp : function() {
			// construct our admin Application so we can test it
			this.getRoot();
		},
		...
		getRoot : function() {
			...
			cls._app = new admin.Application( document );
		...
		*/
		...
		test0000_setServer: function() {
			qx.core.Init.getApplication().addListener( "appInitialized", function() {
				admin.test.TestStatics.SetServerConnection(this.getServerHost(), this.getServerPort(),
