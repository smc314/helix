 ...
 * <tt>test</tt> folder.
 */
qx.Class.define("admin.test.HelixEditorTest",
{
	extend : admin.test.HubTest,
	type : "abstract",
	...
	members :
	{
		...
		test0005_deleteOldNode: function() {
			...
			var editorUtils = new admin.test.EditorTestUtil( this,
					                                       this._treeNode,
														   this._tabNameNew,
					                                       this._tabNameSaved );
		...
		test0010_OpenNewEditor: function() {
			admin.test.TestStatics.selectToolsMenuItem( "New", this._toolsNew );
		...
		test0100_DeleteNewObject : function() {
			...
			this.getFileTreeNode( treePath, function(treeNode) {
				...
				admin.test.TestStatics.waitForDialog( "Deleting...", function(dialog) {
					dialog.ok_btn.execute();
