...
/** This class defines a dialog that presents a list box 
  ...
  */
qx.Class.define("PACKAGE.dialog.ManageServerConnections", {
	...
	members : {
		...
		doFormLayout : function ( layout ) {
			var a1 = new qx.ui.basic.Atom("Use the delete button to remove any server connections that are no longer required.", "PACKAGE/icon/64x64/shadow/server_edit.png" );
			a1.setRich( true );
			layout.add(a1);

			PACKAGE.Statics.addBoxWithButtons( this, layout, "listBox", 1, 1,
				"deleteBtn", "Delete", "PACKAGE/icon/16x16/plain/delete2.png"
			);

			this.listBox.setSelectionMode( "multi" );
			this.deleteBtn.addListener("execute", this.deleteSelection, this );
			PACKAGE.Api.UserProperties( {}, {}, this, this.loadList );
		...
		deleteSelection: function() {
			...
			PACKAGE.Api.UserProperties( {}, delList, this, this.loadList );
		}
