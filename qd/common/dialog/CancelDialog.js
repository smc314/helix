...
/** This class defines a simple dialog base class that defines a dialog window
  ...
  */
qx.Class.define("PACKAGE.dialog.CancelDialog", {
	...
	construct : function ( title, addToolbar ) {
		...
		this.cancel_btn = new qx.ui.form.Button("OK", "PACKAGE/icon/16x16/plain/error.png");
		PACKAGE.Statics.setHtmlID( this.cancel_btn, "OK" );
	...
	members : {
		...
		addButton : function (buttonLabel, buttonIcon) {
			...
			PACKAGE.Statics.setHtmlID( btn, buttonLabel );
