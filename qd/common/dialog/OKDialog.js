...
/** This class defines a simple dialog base class that defines a dialog window
  ...
  */
qx.Class.define("PACKAGE.dialog.OKDialog", {
	...
	construct : function ( title, addToolbar ) {
		...
		PACKAGE.Statics.setHtmlID( this, title);
		...
		this.ok_btn = new qx.ui.form.Button("OK", "PACKAGE/icon/16x16/plain/ok.png");
		PACKAGE.Statics.setHtmlID( this.ok_btn, "OK" );
