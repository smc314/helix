...
************************************************************************ */
qx.Class.define("PACKAGE.ObjectListDisplay", {
	...
	members : {
		...
		createRMCMenu : function(ev) {
			...
			// refresh
			PACKAGE.Statics.addToRMCMenu( this.rmc, "Refresh", 'PACKAGE/icon/basic_foundation/16x16/plain/refresh.png',
				this.rmcFullRefresh, this);
			
			// edit
			PACKAGE.Statics.addToRMCMenu( this.rmc, "Edit...", 'PACKAGE/icon/basic_foundation/16x16/plain/edit.png',
				this.rmcEdit, this);
			
			// Add New...
			if(this.doAddNew){
				PACKAGE.Statics.addToRMCMenu( this.rmc, "Add New...", 'PACKAGE/icon/basic_foundation/16x16/plain/document_new.png',
					this.addNew, this);
			}
			
			// Delete...
			if(this.deleteApi !== null){
				PACKAGE.Statics.addToRMCMenu( this.rmc, "Delete...", 'PACKAGE/icon/basic_foundation/16x16/plain/delete2.png',
					this.doDelete, this);
			}
		...
		rmcEdit : function(ev) {
			...
			if( this.table.getSelectionModel().isSelectionEmpty() ){
				PACKAGE.Statics.doAlert("Nothing selected to edit!");
				return;
			}
	...
	destruct : function () {
		...
		PACKAGE.Statics.cleanupStandardTable( this.table );
