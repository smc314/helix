 ...
 *
 */
qx.Class.define("PACKAGE.test.HelixTest",
{
	...
	members :
	{
		...
		/**
		  ...
		  */
		setUp : function() {
			// construct our PACKAGE Application so we can test it
			this.getRoot();
		},
		...
		getRoot : function() {
			...
			cls._app = new PACKAGE.Application( document );
		...
		*/
		...
		test0000_setServer: function() {
			qx.core.Init.getApplication().addListener( "appInitialized", function() {
				PACKAGE.test.TestStatics.SetServerConnection(this.getServerHost(), this.getServerPort(),
