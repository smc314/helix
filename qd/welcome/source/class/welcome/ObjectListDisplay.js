...
************************************************************************ */
qx.Class.define("welcome.ObjectListDisplay", {
	...
	members : {
		...
		closePage : function () {
			var our_page = welcome.Statics.findQXParent(this, qx.ui.tabview.Page );
			if(our_page === null){
				return;
			}
		...
		doCreateTable : function () {
			...
			this.table.set({ height:1, minHeight:1 });
			...
			resizeBehavior.set(0, { width:"1*", minWidth:45, maxWidth:80  });
		...
		createRMCMenu : function(ev) {
			...
			// refresh
			welcome.Statics.addToRMCMenu( this.rmc, "Refresh", 'welcome/icon/basic_foundation/16x16/plain/refresh.png',
				this.rmcFullRefresh, this);

			// edit
			welcome.Statics.addToRMCMenu( this.rmc, "Edit...", 'welcome/icon/basic_foundation/16x16/plain/edit.png',
				this.rmcEdit, this);

			// Add New...
			if(this.doAddNew){
				welcome.Statics.addToRMCMenu( this.rmc, "Add New...", 'welcome/icon/basic_foundation/16x16/plain/document_new.png',
					this.addNew, this);
			}

			// Delete...
			if(this.deleteApi !== null){
				welcome.Statics.addToRMCMenu( this.rmc, "Delete...", 'welcome/icon/basic_foundation/16x16/plain/delete2.png',
					this.doDelete, this);
			}
		...
		rmcEdit : function(ev) {
			...
			if( this.table.getSelectionModel().isSelectionEmpty() ){
				welcome.Statics.doAlert("Nothing selected to edit!");
				return;
			}
	...
	destruct : function () {
		...
		welcome.Statics.cleanupStandardTable( this.table );
