 ...
 * <tt>test</tt> folder.
 */
qx.Class.define("welcome.test.HelixEditorTest",
{
	extend : welcome.test.HubTest,
	type : "abstract",
	...
	members :
	{
		...
		test0005_deleteOldNode: function() {
			...
			var editorUtils = new welcome.test.EditorTestUtil( this,
					                                       this._treeNode,
														   this._tabNameNew,
					                                       this._tabNameSaved );
		...
		test0010_OpenNewEditor: function() {
			welcome.test.TestStatics.selectToolsMenuItem( "New", this._toolsNew );
		...
		test0100_DeleteNewObject : function() {
			...
			this.getFileTreeNode( treePath, function(treeNode) {
				...
				welcome.test.TestStatics.waitForDialog( "Deleting...", function(dialog) {
					dialog.ok_btn.execute();
