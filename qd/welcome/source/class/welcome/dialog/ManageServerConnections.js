...
************************************************************************ */
/* ************************************************************************
#asset(welcome/icon/64x64/shadow/server_edit.png)
...
/** This class defines a dialog that presents a list box
  ...
  */
qx.Class.define("welcome.dialog.ManageServerConnections", {
	...
	members : {
		...
		doFormLayout : function ( layout ) {
			var a1 = new qx.ui.basic.Atom("Use the delete button to remove any server connections that are no longer required.", "welcome/icon/64x64/shadow/server_edit.png" );
			a1.setRich( true );
			layout.add(a1);

			welcome.Statics.addBoxWithButtons( this, layout, "listBox", 1, 1,
				"deleteBtn", "Delete", "welcome/icon/16x16/plain/delete2.png"
			);

			this.listBox.setSelectionMode( "multi" );
			this.deleteBtn.addListener("execute", this.deleteSelection, this );
			welcome.Api.UserProperties( {}, {}, this, this.loadList );
		...
		deleteSelection: function() {
			...
			welcome.Api.UserProperties( {}, delList, this, this.loadList );
		}
