...
************************************************************************ */
/* ************************************************************************
#asset(welcome/icon/64x64/shadow/server_connection.png)
************************************************************************ */
...
/** This class defines a dialog that presents a list box
  ...
  */
qx.Class.define("welcome.dialog.ServerConnectDialog", {
	extend : welcome.dialog.OKCancelDialog,

	/** You may pass in window title, icon, and label values.
	  */
	construct : function ( title) {
		this.icon = "welcome/icon/64x64/shadow/server_connection.png";
	...
	members : {
		...
		doFormLayout : function ( layout ) {
			...
			welcome.Statics.addFieldsToForm(this, layout,
