...
#asset(welcome/icon/16x16/plain/floppy_disk_ok.png)
#asset(welcome/icon/16x16/plain/refresh.png)
#asset(welcome/icon/16x16/plain/help2.png)
************************************************************************ */
qx.Class.define("welcome.ObjectEdit", {
	...
	members: {
		...
		*/
		setupNamesAndFunctions: function () {
			this.selectApiCall = welcome.Api.selectOneProductInfo;
		...
		*/
		...
		hookCloseEvent : function(){
			...
			our_page.getButton().getChildControl("close-button").addListener("mousedown", function(e){
				...
				var dialog = new welcome.dialog.QuestionDialog(windowTitle, windowIcon, windowLabel);
				qx.core.Init.getApplication().getRoot().add( dialog );
				dialog.addOkEventListener("execute", function(){
					// forcibly remove the tab page:
					var tabView = welcome.Statics.findQXParent(our_page, qx.ui.tabview.TabView);
		...
		*/
		initializeToolbar: function (tb) {
			...
			// Save button
			welcome.Statics.addToToolbarWithShortcut(sc_part, "welcome/icon/16x16/plain/floppy_disk_ok.png",
		...
		addHelpMenu: function (tb) {
			...
			// Help button
			welcome.Statics.addToToolbar(help_part, "welcome/icon/16x16/plain/help2.png",
		...
		createRMCMenu: function (ev) {
			...
			// refresh
			welcome.Statics.addToRMCMenu(this.rmc, "Refresh", 'welcome/icon/16x16/plain/refresh.png',
				this.doRevert, this);
		...
		getHelpUrl: function () {
			return "/welcome/NetHelp/welcome.htm";
		},
