...
************************************************************************ */
/* ************************************************************************
#asset(welcome/icon/16x16/plain/edit.png)
#asset(welcome/icon/16x16/plain/document_new.png)
#asset(welcome/icon/16x16/plain/delete2.png)
************************************************************************ */
qx.Class.define("welcome.StandardTable", {
		...
		createRMCMenu : function() {
			...
			if(this.getEditRowFunction() !== null){
				welcome.Statics.addToRMCMenu( this.rmc, "Edit...",
					"welcome/icon/16x16/plain/edit.png",
					this.rmcEdit, this );
			}
			...
			if(this.getAddRowButton() !== null){
				welcome.Statics.addToRMCMenu( this.rmc, "Add New...",
					"welcome/icon/16x16/plain/document_new.png",
			...
			if(this.getDeleteRowButton() !== null){
				welcome.Statics.addToRMCMenu( this.rmc, "Delete...",
					"welcome/icon/16x16/plain/delete2.png",
