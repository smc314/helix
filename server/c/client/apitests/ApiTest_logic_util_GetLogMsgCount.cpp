...
void ApiTest_logic_util_GetLogMsgCount_NoAuthorization_ShouldFail();
void ApiTest_logic_util_GetLogMsgCount_CallWithEmptyPayload();
void ApiTest_logic_util_GetLogMsgCount_CallWithValidPayload();
void ApiTest_logic_util_GetLogMsgCount_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/util/GetLogMsgCount here

/** This is the main method that executes the tests for the /logic/util/GetLogMsgCount api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_util_GetLogMsgCount()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/util/GetLogMsgCount") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_util_GetLogMsgCount_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_util_GetLogMsgCount_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_util_GetLogMsgCount_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_util_GetLogMsgCount_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/util/GetLogMsgCount without any authorization information.  This should
...
/** This test will call the /logic/util/GetLogMsgCount with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetLogMsgCount_CallWithEmptyPayload()
{
...
/** This test will call the /logic/util/GetLogMsgCount with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetLogMsgCount_CallWithValidPayload()
{
...
/** This test will call the /logic/util/GetLogMsgCount with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetLogMsgCount_CallWithInvalidPayload()
{
