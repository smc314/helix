...
void ApiTest_logic_util_SaveLogMsg_NoAuthorization_ShouldFail();
void ApiTest_logic_util_SaveLogMsg_CallWithEmptyPayload();
void ApiTest_logic_util_SaveLogMsg_CallWithValidPayload();
void ApiTest_logic_util_SaveLogMsg_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/util/SaveLogMsg here

/** This is the main method that executes the tests for the /logic/util/SaveLogMsg api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_util_SaveLogMsg()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/util/SaveLogMsg") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_util_SaveLogMsg_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_util_SaveLogMsg_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_util_SaveLogMsg_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_util_SaveLogMsg_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/util/SaveLogMsg without any authorization information.  This should
...
/** This test will call the /logic/util/SaveLogMsg with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_util_SaveLogMsg_CallWithEmptyPayload()
{
...
/** This test will call the /logic/util/SaveLogMsg with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_SaveLogMsg_CallWithValidPayload()
{
...
/** This test will call the /logic/util/SaveLogMsg with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_SaveLogMsg_CallWithInvalidPayload()
{
