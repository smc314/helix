...
void ApiTest_logic_admin_GetGroups_NoAuthorization_ShouldFail();
void ApiTest_logic_admin_GetGroups_CallWithEmptyPayload();
void ApiTest_logic_admin_GetGroups_CallWithValidPayload();
void ApiTest_logic_admin_GetGroups_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/admin/GetGroups here

/** This is the main method that executes the tests for the /logic/admin/GetGroups api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_admin_GetGroups()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/admin/GetGroups") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_admin_GetGroups_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_admin_GetGroups_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_admin_GetGroups_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_admin_GetGroups_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/admin/GetGroups without any authorization information.  This should
  * be rejected by the server, and we should receive the error message.
  */
void ApiTest_logic_admin_GetGroups_NoAuthorization_ShouldFail()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetGroups_NoAuthorization_ShouldFail" )

	// Remove this out when you've updated these tests to be real
	ASSERT_TRUE(false, "Test not implemented yet.");

	// Api /logic/admin/GetGroups has no input values.
	xmlDocPtr resp;
	resp = m_api->GetGroups();
	if(m_log_steps){
...
/** This test will call the /logic/admin/GetGroups with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetGroups_CallWithEmptyPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetGroups_CallWithEmptyPayload" )
...
/** This test will call the /logic/admin/GetGroups with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetGroups_CallWithValidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetGroups_CallWithValidPayload" )
...
/** This test will call the /logic/admin/GetGroups with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetGroups_CallWithInvalidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetGroups_CallWithInvalidPayload" )
