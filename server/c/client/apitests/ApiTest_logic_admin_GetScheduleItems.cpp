...
void ApiTest_logic_admin_GetScheduleItems_NoAuthorization_ShouldFail();
void ApiTest_logic_admin_GetScheduleItems_CallWithEmptyPayload();
void ApiTest_logic_admin_GetScheduleItems_CallWithValidPayload();
void ApiTest_logic_admin_GetScheduleItems_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/admin/GetScheduleItems here

/** This is the main method that executes the tests for the /logic/admin/GetScheduleItems api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_admin_GetScheduleItems()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/admin/GetScheduleItems") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_admin_GetScheduleItems_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_admin_GetScheduleItems_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_admin_GetScheduleItems_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_admin_GetScheduleItems_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/admin/GetScheduleItems without any authorization information.  This should
...
/** This test will call the /logic/admin/GetScheduleItems with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetScheduleItems_CallWithEmptyPayload()
{
...
/** This test will call the /logic/admin/GetScheduleItems with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetScheduleItems_CallWithValidPayload()
{
...
/** This test will call the /logic/admin/GetScheduleItems with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetScheduleItems_CallWithInvalidPayload()
{
