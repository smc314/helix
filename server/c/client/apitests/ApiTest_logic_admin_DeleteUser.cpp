...
void ApiTest_logic_admin_DeleteUser_NoAuthorization_ShouldFail();
void ApiTest_logic_admin_DeleteUser_CallWithEmptyPayload();
void ApiTest_logic_admin_DeleteUser_CallWithValidPayload();
void ApiTest_logic_admin_DeleteUser_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/admin/DeleteUser here

/** This is the main method that executes the tests for the /logic/admin/DeleteUser api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_admin_DeleteUser()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/admin/DeleteUser") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_admin_DeleteUser_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_admin_DeleteUser_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_admin_DeleteUser_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_admin_DeleteUser_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/admin/DeleteUser without any authorization information.  This should
  * be rejected by the server, and we should receive the error message.
  */
void ApiTest_logic_admin_DeleteUser_NoAuthorization_ShouldFail()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_DeleteUser_NoAuthorization_ShouldFail" )

	// Remove this out when you've updated these tests to be real
	ASSERT_TRUE(false, "Test not implemented yet.");

	// Api /logic/admin/DeleteUser requires an object of type User as input.
	User inputObj;
	...
	xmlDocPtr resp;
	resp = m_api->DeleteUser(inputObj);
	if(m_log_steps){
...
/** This test will call the /logic/admin/DeleteUser with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_DeleteUser_CallWithEmptyPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_DeleteUser_CallWithEmptyPayload" )
...
/** This test will call the /logic/admin/DeleteUser with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_DeleteUser_CallWithValidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_DeleteUser_CallWithValidPayload" )
...
/** This test will call the /logic/admin/DeleteUser with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_DeleteUser_CallWithInvalidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_DeleteUser_CallWithInvalidPayload" )
