...
void ApiTest_logic_admin_GetOneUser_NoAuthorization_ShouldFail();
void ApiTest_logic_admin_GetOneUser_CallWithEmptyPayload();
void ApiTest_logic_admin_GetOneUser_CallWithValidPayload();
void ApiTest_logic_admin_GetOneUser_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/admin/GetOneUser here

/** This is the main method that executes the tests for the /logic/admin/GetOneUser api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_admin_GetOneUser()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/admin/GetOneUser") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_admin_GetOneUser_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_admin_GetOneUser_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_admin_GetOneUser_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_admin_GetOneUser_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/admin/GetOneUser without any authorization information.  This should
  * be rejected by the server, and we should receive the error message.
  */
void ApiTest_logic_admin_GetOneUser_NoAuthorization_ShouldFail()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneUser_NoAuthorization_ShouldFail" )

	// Remove this out when you've updated these tests to be real
	ASSERT_TRUE(false, "Test not implemented yet.");

	// Api /logic/admin/GetOneUser requires an object of type User as input.
	User inputObj;
	...
	xmlDocPtr resp;
	resp = m_api->GetOneUser(inputObj);
	if(m_log_steps){
...
/** This test will call the /logic/admin/GetOneUser with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneUser_CallWithEmptyPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneUser_CallWithEmptyPayload" )
...
/** This test will call the /logic/admin/GetOneUser with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneUser_CallWithValidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneUser_CallWithValidPayload" )
...
/** This test will call the /logic/admin/GetOneUser with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneUser_CallWithInvalidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneUser_CallWithInvalidPayload" )
