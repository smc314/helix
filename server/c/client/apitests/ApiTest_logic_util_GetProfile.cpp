...
void ApiTest_logic_util_GetProfile_NoAuthorization_ShouldFail();
void ApiTest_logic_util_GetProfile_CallWithEmptyPayload();
void ApiTest_logic_util_GetProfile_CallWithValidPayload();
void ApiTest_logic_util_GetProfile_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/util/GetProfile here

/** This is the main method that executes the tests for the /logic/util/GetProfile api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_util_GetProfile()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/util/GetProfile") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_util_GetProfile_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_util_GetProfile_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_util_GetProfile_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_util_GetProfile_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/util/GetProfile without any authorization information.  This should
...
/** This test will call the /logic/util/GetProfile with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetProfile_CallWithEmptyPayload()
{
...
/** This test will call the /logic/util/GetProfile with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetProfile_CallWithValidPayload()
{
...
/** This test will call the /logic/util/GetProfile with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetProfile_CallWithInvalidPayload()
{
