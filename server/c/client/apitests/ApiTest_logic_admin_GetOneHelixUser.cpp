...
void ApiTest_logic_admin_GetOneHelixUser_NoAuthorization_ShouldFail();
void ApiTest_logic_admin_GetOneHelixUser_CallWithEmptyPayload();
void ApiTest_logic_admin_GetOneHelixUser_CallWithValidPayload();
void ApiTest_logic_admin_GetOneHelixUser_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/admin/GetOneHelixUser here

/** This is the main method that executes the tests for the /logic/admin/GetOneHelixUser api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_admin_GetOneHelixUser()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/admin/GetOneHelixUser") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_admin_GetOneHelixUser_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_admin_GetOneHelixUser_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_admin_GetOneHelixUser_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_admin_GetOneHelixUser_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/admin/GetOneHelixUser without any authorization information.  This should
  * be rejected by the server, and we should receive the error message.
  */
void ApiTest_logic_admin_GetOneHelixUser_NoAuthorization_ShouldFail()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneHelixUser_NoAuthorization_ShouldFail" )

	// Remove this out when you've updated these tests to be real
	ASSERT_TRUE(false, "Test not implemented yet.");

	// Api /logic/admin/GetOneHelixUser requires an object of type HelixUser as input.
	HelixUser inputObj;
	...
	xmlDocPtr resp;
	resp = m_api->GetOneHelixUser(inputObj);
	if(m_log_steps){
...
/** This test will call the /logic/admin/GetOneHelixUser with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneHelixUser_CallWithEmptyPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneHelixUser_CallWithEmptyPayload" )
...
/** This test will call the /logic/admin/GetOneHelixUser with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneHelixUser_CallWithValidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneHelixUser_CallWithValidPayload" )
...
/** This test will call the /logic/admin/GetOneHelixUser with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneHelixUser_CallWithInvalidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneHelixUser_CallWithInvalidPayload" )
