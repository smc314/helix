...
void ApiTest_logic_admin_GetOneGroup_NoAuthorization_ShouldFail();
void ApiTest_logic_admin_GetOneGroup_CallWithEmptyPayload();
void ApiTest_logic_admin_GetOneGroup_CallWithValidPayload();
void ApiTest_logic_admin_GetOneGroup_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/admin/GetOneGroup here

/** This is the main method that executes the tests for the /logic/admin/GetOneGroup api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_admin_GetOneGroup()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/admin/GetOneGroup") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_admin_GetOneGroup_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_admin_GetOneGroup_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_admin_GetOneGroup_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_admin_GetOneGroup_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/admin/GetOneGroup without any authorization information.  This should
  * be rejected by the server, and we should receive the error message.
  */
void ApiTest_logic_admin_GetOneGroup_NoAuthorization_ShouldFail()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneGroup_NoAuthorization_ShouldFail" )

	// Remove this out when you've updated these tests to be real
	ASSERT_TRUE(false, "Test not implemented yet.");

	// Api /logic/admin/GetOneGroup requires an object of type Group as input.
	Group inputObj;
	...
	xmlDocPtr resp;
	resp = m_api->GetOneGroup(inputObj);
	if(m_log_steps){
...
/** This test will call the /logic/admin/GetOneGroup with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneGroup_CallWithEmptyPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneGroup_CallWithEmptyPayload" )
...
/** This test will call the /logic/admin/GetOneGroup with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneGroup_CallWithValidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneGroup_CallWithValidPayload" )
...
/** This test will call the /logic/admin/GetOneGroup with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_admin_GetOneGroup_CallWithInvalidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_admin_GetOneGroup_CallWithInvalidPayload" )
