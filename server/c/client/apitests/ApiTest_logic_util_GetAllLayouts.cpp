...
void ApiTest_logic_util_GetAllLayouts_NoAuthorization_ShouldFail();
void ApiTest_logic_util_GetAllLayouts_CallWithEmptyPayload();
void ApiTest_logic_util_GetAllLayouts_CallWithValidPayload();
void ApiTest_logic_util_GetAllLayouts_CallWithInvalidPayload();

// Define more of your own tests and methods for testing /logic/util/GetAllLayouts here

/** This is the main method that executes the tests for the /logic/util/GetAllLayouts api.  All tests
  * that should be executed against this api should be invoked directly here.
  */
void ApiTest_logic_util_GetAllLayouts()
{
	// Ensure that we should be testing this API
	if(runTestsForApi("/logic/util/GetAllLayouts") == false){
		return; // Tests for this api are not included in this run.
	}

	// Test the Api without authorization:
	ApiTest_logic_util_GetAllLayouts_NoAuthorization_ShouldFail();

	// Test the Api with an empty payload
	ApiTest_logic_util_GetAllLayouts_CallWithEmptyPayload();

	// Test the Api with a valid payload
	ApiTest_logic_util_GetAllLayouts_CallWithValidPayload();

	// Test the Api with an invalid payload
	ApiTest_logic_util_GetAllLayouts_CallWithInvalidPayload();

	// Call any other tests that you have defined here:
}

/** This will call the /logic/util/GetAllLayouts without any authorization information.  This should
  * be rejected by the server, and we should receive the error message.
  */
void ApiTest_logic_util_GetAllLayouts_NoAuthorization_ShouldFail()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_util_GetAllLayouts_NoAuthorization_ShouldFail" )

	// Api /logic/util/GetAllLayouts has no input values.
	xmlDocPtr resp;
	resp = m_api->GetAllLayouts();
	if(m_log_steps){
...
/** This test will call the /logic/util/GetAllLayouts with an empty payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetAllLayouts_CallWithEmptyPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_util_GetAllLayouts_CallWithEmptyPayload" )
...
/** This test will call the /logic/util/GetAllLayouts with a valid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetAllLayouts_CallWithValidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_util_GetAllLayouts_CallWithValidPayload" )
...
/** This test will call the /logic/util/GetAllLayouts with an invalid payload and check the response
  * that is received.
  */
void ApiTest_logic_util_GetAllLayouts_CallWithInvalidPayload()
{
	BEGIN_TEST_METHOD( "ApiTest_logic_util_GetAllLayouts_CallWithInvalidPayload" )
