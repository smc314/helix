...
class Project
{
	public:
		...
		static xmlNodePtr createXmlChildAndGrandchildren(xmlNodePtr parent, const twine& childName, vector<Project* >* vect);
		...
		/** This version of the method allows you to pass in a vector of objects to be
		  ...
		  * block within Sqlite.
		  */
		static void insert(SqlDB& sqldb, vector< Project* >* v, bool useTransaction = true);
