...
class ProjectTable
{
	public:
		...
		static xmlNodePtr createXmlChildAndGrandchildren(xmlNodePtr parent, const twine& childName, vector<ProjectTable* >* vect);
		...
		/** This version of the method allows you to pass in a vector of objects to be
		  ...
		  * block within Sqlite.
		  */
		static void insert(SqlDB& sqldb, vector< ProjectTable* >* v, bool useTransaction = true);
