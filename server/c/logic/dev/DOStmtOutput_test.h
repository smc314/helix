...
#ifndef DOSTMTOUTPUT_TEST_H
#define DOSTMTOUTPUT_TEST_H
...
/** This is a generated data object test class that is used for testing the data
  * object called DOStmtOutput.
  */
class DOStmtOutputTest : public DataObjectTestClass
{
	private:
		/// Copy constructor is private to prevent use
		DOStmtOutputTest(const DOStmtOutputTest& c) {}

		/// Assignment operator is private to prevent use
		DOStmtOutputTest& operator=(const DOStmtOutputTest& c) { return *this; }

		/// Registers us with the global factory map
		static DataObjectTestClassRegister< DOStmtOutputTest > reg;
	...
	public:
		...
		static bool compareObjects( DOStmtOutput* first, DOStmtOutput* second);

		/// Compare two lists of objects to see if they are the same
		static bool compareLists( vector< DOStmtOutput* >* first, vector< DOStmtOutput* >* second);
		...
		/** This method will use our input XML document to prepare for and test
		  * the DOStmtOutput.insert method.  We will use our list of output
		...
		/** This method will use our input XML document to prepare for and test
		  * the DOStmtOutput.selectAllForDOStmt method.  We will use our list of output
		  * xml documents to verify the output of this method.  If the list of ourput
		  * documents is empty, we will simply ensure that no exceptions are thrown using
		  * the given XML input document.
		  */
...
#endif // DOSTMTOUTPUT_TEST_H defined
