...
class ProjectData
{
	public:
		...
		static xmlNodePtr createXmlChildAndGrandchildren(xmlNodePtr parent, const twine& childName, vector<ProjectData* >* vect);
		...
		/** This version of the method allows you to pass in a vector of objects to be
		  ...
		  * block within Sqlite.
		  */
		static void insert(SqlDB& sqldb, vector< ProjectData* >* v, bool useTransaction = true);
