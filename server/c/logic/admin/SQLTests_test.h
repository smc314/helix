...
#ifndef SQLTESTS_TEST_H
#define SQLTESTS_TEST_H
...
/** This is a generated data object test class that is used for testing the data
  * object called SQLTests.
  */
class SQLTestsTest : public DataObjectTestClass
{
	private:
		/// Copy constructor is private to prevent use
		SQLTestsTest(const SQLTestsTest& c) {}

		/// Assignment operator is private to prevent use
		SQLTestsTest& operator=(const SQLTestsTest& c) { return *this; }

		/// Registers us with the global factory map
		static DataObjectTestClassRegister< SQLTestsTest > reg;
	...
	public:
		...
		static bool compareObjects( SQLTests* first, SQLTests* second);

		/// Compare two lists of objects to see if they are the same
		static bool compareLists( vector< SQLTests* >* first, vector< SQLTests* >* second);
		...
		/** This method will use our input XML document to prepare for and test
		  * the SQLTests.unused method.  We will use our list of output
