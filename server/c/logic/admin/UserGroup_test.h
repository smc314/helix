...
#ifndef USERGROUP_TEST_H
#define USERGROUP_TEST_H
...
/** This is a generated data object test class that is used for testing the data
  * object called UserGroup.
  */
class UserGroupTest : public DataObjectTestClass
{
	private:
		/// Copy constructor is private to prevent use
		UserGroupTest(const UserGroupTest& c) {}

		/// Assignment operator is private to prevent use
		UserGroupTest& operator=(const UserGroupTest& c) { return *this; }

		/// Registers us with the global factory map
		static DataObjectTestClassRegister< UserGroupTest > reg;
	...
	public:
		...
		static bool compareObjects( UserGroup* first, UserGroup* second);

		/// Compare two lists of objects to see if they are the same
		static bool compareLists( vector< UserGroup* >* first, vector< UserGroup* >* second);
		...
		/** This method will use our input XML document to prepare for and test
		  * the UserGroup.addUserGroup method.  We will use our list of output
		  ...
		  */
		void addUserGroup(IOConn& ioc, xmlNodePtr node);
		...
		/** This method will use our input XML document to prepare for and test
		  * the UserGroup.selectAll method.  We will use our list of output
		  * xml documents to verify the output of this method.  If the list of ourput
		  * documents is empty, we will simply ensure that no exceptions are thrown using
		  * the given XML input document.
		  */
		...
		/** This method will use our input XML document to prepare for and test
		  * the UserGroup.selectUsersForGroup method.  We will use our list of output
		  * xml documents to verify the output of this method.  If the list of ourput
		  * documents is empty, we will simply ensure that no exceptions are thrown using
		  * the given XML input document.
		  */
		...
		/** This method will use our input XML document to prepare for and test
		  * the UserGroup.selectGroupsForUser method.  We will use our list of output
		  * xml documents to verify the output of this method.  If the list of ourput
		  * documents is empty, we will simply ensure that no exceptions are thrown using
		  * the given XML input document.
		  */
...
#endif // USERGROUP_TEST_H defined
