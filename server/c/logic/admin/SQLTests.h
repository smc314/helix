...
class SQLTests
{
	public:
		...
		SQLTests(const SQLTests& c);

		/// Standard Assignment Operator
		SQLTests& operator=(const SQLTests& c);
		...
		SQLTests(xmlNodePtr node);

		/// Read an XML Node to set our contents
		SQLTests& readXmlNode(xmlNodePtr node);
		...
		static vector<SQLTests* >* readXmlChildren(xmlNodePtr parent);
		...
		/* defined in the file ../logic/admin/SQLTests.sql.xml */
		/* ******************************************************************************** */
		...
		/** This is an INSERT method.  It is designed to run a single insert
		  ...
		  * </pre>
		  */
		static void unused(OdbcObj& odbc, SQLTests& obj );
		...
		/** This mimics the above in functionality, but allows you to pass in your own
		  ...
		  * the inputs as well.
		  */
		static void unused(OdbcObj& odbc, twine& stmt, bool useInputs, SQLTests& obj );
		...
		/** This method will do a replacement of all of the parameter markers in
		  ...
		  */
		static twine unused_prepSQL(IOConn& ioc, SQLTests& obj );
...
/** This typedef makes it easy to declare smart pointer vectors of the SQLTests
  * object type.  Use this to keep your code clean and easy to read. For example:
  * <pre>
  * SQLTests_svect myVect = SQLTests::selectSomething(odbc);
  * </pre>
  */
typedef sptr< vector< SQLTests* >, SQLTests::deleteVector> SQLTests_svect;

}}} // End Namespace stack

#endif // SQLTESTS_H defined
