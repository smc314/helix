...
{
	/// <summary>
	/// Thanks to this code for this class: https://github.com/samuelneff/MimeTypeMap/blob/master/src/MimeTypeMap.cs
	/// </summary>
	public static class MimeTypeMap
	{
		...
		public static bool IsMimeCompressed(string mimeType){
