...
/* Use thse for local development */
	define('QA_MYSQL_USERNAME', 'q2a');
	define('QA_MYSQL_PASSWORD', 'hithere');
	define('QA_MYSQL_DATABASE', 'q2a');
	
/* Use thse for production deployment */
/*
	define('QA_MYSQL_USERNAME', 'qa');
	define('QA_MYSQL_PASSWORD', 'h3l1xq@');
	define('QA_MYSQL_DATABASE', 'helixqa');
*/
