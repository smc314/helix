 ...
 */
public class RequestTrial extends HttpServlet
{ 
    	...
    	throws ServletException, IOException 
    {
        ...
        try {
            ...
            Document doc = newDocument("CustRequestTrial"); 
			Element root = doc.getDocumentElement();
			root.setAttribute("custname", req.getParameter("contactname"));
			root.setAttribute("contactname", req.getParameter("contactname"));
			root.setAttribute("contactemail", req.getParameter("contactemail"));
			root.setAttribute("contactphone", req.getParameter("contactphone"));
			//root.setAttribute("contactaddr1", req.getParameter("contactaddr1"));
			//root.setAttribute("contactaddr2", req.getParameter("contactaddr2"));
			//root.setAttribute("contactaddr3", req.getParameter("contactaddr3"));
			//root.setAttribute("contactcity", req.getParameter("contactcity"));
			//root.setAttribute("contactstate", req.getParameter("contactstate"));
			//root.setAttribute("contactzip", req.getParameter("contactzip"));
			//root.setAttribute("contactcountry", req.getParameter("contactcountry"));
			root.setAttribute("user", "licreq");
			root.setAttribute("pass", "l1cr3q");
			root.setAttribute("dbname", "Zed");
			Document serverResp = sendToZedServer("zed.hericus.com", 443, doc, "CustRequestTrial", true);
			m_out.println("<b>");
			try {
				returnHasErrors(serverResp, true);
				m_out.println("Your Free 60-Day Trial Licenses have been e-mailed to: " + req.getParameter("contactemail"));
				m_out.println("<br/>");
				m_out.println("<br/>");
				...
				m_out.println("<br/><br/>");
				m_out.println("Your Server License codes have been created and are ready for use:<br/><br/>");
				...
				m_out.println("<p>");
				m_out.println("Please contact <a href=\"mailto:support@hericus.com\">Hericus Support</a> to request your Free 60-Day Trial License.");
				m_out.println("</p>");
			}
			m_out.println("</b>");
        } catch (Throwable t){
